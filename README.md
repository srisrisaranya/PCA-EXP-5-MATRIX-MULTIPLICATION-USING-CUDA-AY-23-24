...
## OUTPUT:
<img width="1311" height="597" alt="image" src="https://github.com/user-attachments/assets/bb80893f-43e1-47d4-a44d-ec13a61872c0" />



## RESULT:
Thus the program has been executed by using CUDA to mulptiply two matrices. It is observed that there are variations in host and device elapsed time. Device took 0.000165 time and host took  0.000001 time.
